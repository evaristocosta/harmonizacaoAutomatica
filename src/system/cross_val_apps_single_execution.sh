...
# src/system/cross_val_apps_single_execution.sh vgg16 256 100 sgd 0.1 0.9 0 10 0 &
# src/system/cross_val_apps_single_execution.sh resnet101 256 400 sgd 0.0001 0.9 0 5 5 &
