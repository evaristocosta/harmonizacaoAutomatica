...
# src/system/cross_val_apps_single_execution.sh alexnet_optimized 16 50 adam 1e-4 0.9 0 30 0 &
# src/system/cross_val_apps_single_execution.sh alexnet_manual 16 50 adam 1e-3 0.9 0 30 0 &
